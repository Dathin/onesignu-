...
public class OneSignupService {
    ...
    public OneSignupService(UpsertData upsertData, SearchData searchData, PatchDataMapper patchDataMapper, SearchFieldsMapper searchFieldsMapper, FoundFieldsMapper foundFieldsMapper) {
